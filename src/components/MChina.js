    ...
    return (
        ...
        >
            <path
                ...
                className="shape"
                fill={selectedCountry === country ?  "rgba(255,164,162,0.5)": "rgba(0,0,0,0.25)"}
                stroke={selectedCountry === country ?  "red": (hoveredCountry === country && selectedCountry !== country) ? "red": "rgba(255,164,162,0.5)" }
                //Stroke is red if hovered, but locks red if selected
                id="Modern China"
                strokeWidth="4"
